...
const p1 = Promise.resolve(10);                                                 //  -> в Исполнено (завершился с успехом НЕМЕДЛЕННО(синхронно))                                
const p2 = new Promise(resolve => setTimeout(() => resolve(20), 1000));         //  -> в Исполнено (завершился с успехом)(асинхронно)
