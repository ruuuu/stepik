...
team.listMembers();      // тк вызов как obj.method(), то this = team, выведет undefined
team.listMembersArrow(); //  тк вызов как obj.method(), то this = team, выведет 'Avengers'