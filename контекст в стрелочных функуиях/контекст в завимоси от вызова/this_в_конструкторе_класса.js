...
// Стрелочная функция(метод) и обычная функция(метод) в конструкторе, в них this = экземпляру класса(объекту класса) 
// Стрелочная функция(метод) в классе (не в конструкторе), в ней this = экземпляру класса(объекту класса) 
// Обычная функция(метод) в классе (не в конструкторе), в ней this зависит от контекста вызова: если вызов как obj.method(), то this = экземпляру класса, если как method() то this = undefined
